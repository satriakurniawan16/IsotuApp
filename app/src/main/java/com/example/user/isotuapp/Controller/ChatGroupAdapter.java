...
public class ChatGroupAdapter extends RecyclerView.Adapter<ChatGroupAdapter.ViewHolder> {
    ...
    public ChatGroupAdapter(Context context, ArrayList<Chatlist> data, ArrayList<String> dataId,View emptyView,boolean ischat,
                            ChatGroupAdapter.ClickHandler handler) {
        mContext = context;
        mData = data;
        mDataId = dataId;
                        ...
                        public boolean onLongClick(View v) {
                            ...
                            hapus.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    DatabaseReference databasenotif = FirebaseDatabase.getInstance().getReference("ChatlistGrup").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
                                    databasenotif.child(chatlist.getId()).removeValue();
