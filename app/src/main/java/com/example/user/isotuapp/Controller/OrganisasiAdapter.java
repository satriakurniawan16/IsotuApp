...
public class OrganisasiAdapter  extends RecyclerView.Adapter<OrganisasiAdapter.ViewHolder> {
    private ClickHandler mClickHandler;
    private Context mContext;
    private ArrayList<Organiasasi> mData;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(
                R.layout.list_item_organisasi, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Organiasasi pet = mData.get(position);
        holder.nameTextView.setText(pet.getNama());
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        ViewHolder(View itemView) {
            super(itemView);
            nameTextView = itemView.findViewById(R.id.namaorganisasi);
